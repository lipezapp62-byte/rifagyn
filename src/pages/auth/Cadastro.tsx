...
export default function Cadastro() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const sanitizedToken = token.toString().replace(/"/g, ""); // ✅ igual ao login
    ...
    "
                ...
                <div className="text-center text-sm font-semibold text-primary bg-primary/10 border border-primary/20 rounded-lg py-2 px-3 leading-tight">
                    Após criar uma conta você<br></br>poderá visualizar os seus números!
                </div>
                ...
                <div className="text-center text-xs text-muted-foreground">
                    Já tem conta?{" "}
                    <Link to="/auth/login" className="text-[#ff6100] font-semibold">
                        Entrar
                    </Link>
                </div>
            </div>
